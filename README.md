...
- Instalátor NSIS nebo MSI (viz [Releases](https://github.com/h0nyik/GrommeR/releases))
...
- `src-tauri/target/release/bundle/nsis/Grommet.Marks_0.2.1_x64-setup.exe` – NSIS instalátor
- `src-tauri/target/release/bundle/msi/Grommet.Marks_0.2.1_x64_en-US.msi` – MSI instalátor
